		...
		[
			{
				...
				icon: (
					<Sun
						size={20}
						color={mode === "light" ? colors.textInverse : colors.text}
					/>
				),
			},
			{
			...
			},
			{
				...
				icon: (
					<Smartphone
						size={20}
						color={mode === "system" ? colors.textInverse : colors.text}
					/>
				),
			},
		];
				...
				{themeOptions.map((option) => (
					<TouchableOpacity
						...
						style={[
							...
							{
								backgroundColor:
									option.value === mode ? colors.primary : colors.input,
							},
						]}
						onPress={() => {
					...
					>
						...
						<Text
							style={[
								...
								{
									color:
										option.value === mode ? colors.textInverse : colors.text,
									marginLeft: 8,
								},
							]}
						>
